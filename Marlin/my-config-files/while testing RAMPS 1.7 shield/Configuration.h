/********* Preliminary Configuration example for testing RAMPS 1.7B & 1.7C    ***************/
/********* Preliminary Configuration example for testing RAMPS 1.7B & 1.7C    ***************/
/********* Preliminary Configuration example for testing RAMPS 1.7B & 1.7C    ***************/
/********* Preliminary Configuration example for testing RAMPS 1.7B & 1.7C    ***************/
 ...
 *     - LCD universal bi-directional 3V<->5V adapter for aux3+4 is working, but still beeps during boot and programming. It is fixed using a 4K7 pull down resistor.
